...
<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
  <header class="mb-auto">
    <div>
      <h3 class="float-md-start mb-0">Black box</h3>
      <nav class="nav nav-masthead justify-content-center float-md-end">
        <a class="nav-link active" aria-current="page" href="#">Instagram</a>
        <a class="nav-link" href="#">Tik tok</a>
  ...
  <footer class="mt-auto text-white-50">
    <p>Siguenos en nuestras redes como <a href="https://getbootstrap.com/" class="text-white">Bootstrap</a>, y <a href="https://twitter.com/mdo" class="text-white">@mdo</a>.</p>
  </footer>
</div>
